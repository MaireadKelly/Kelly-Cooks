...
urlpatterns = [
    ...
    # reviews
    path("<int:pk>/review/", add_review, name="add_review"),        # add review to recipe (recipe pk)
    path("review/<int:pk>/edit/", edit_review, name="edit_review"), # edit a review (review pk)
