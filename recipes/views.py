...
class RecipeDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Add the review form and the list of reviews to the context
        context['review_form'] = ReviewForm()
        context['reviews'] = self.object.review_set.all()  # Assuming a ForeignKey relationship
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            review.recipe = self.object  # Link the review to the current recipe
            review.user = request.user   # Link the review to the logged-in user
            review.save()
