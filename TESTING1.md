...
The [W3C Markup Validation Service](https://validator.w3.org/) was used to validate the HTML of all key pages of the site.  
Validation was carried out on the **rendered HTML** of each page (via “View Page Source”), ensuring the checks include the base template and all includes.

All key pages passed validation with **no errors**.

### Validation Results

| Page Tested             | Result                  |
|-------------------------|-------------------------|
| Landing Page (`/`)      | ✅ No errors found      |
| Recipe List (`/recipes/`) | ✅ No errors found   |
| Recipe Detail (`/recipes/<id>/`) | ✅ No errors found |
| Add Recipe (`/recipes/add/`) | ✅ No errors found |
| Edit Recipe (`/recipes/edit/<id>/`) | ✅ No errors found |
| Delete Confirmation (`/recipes/delete/<id>/`) | ✅ No errors found |
| My Recipes (`/recipes/my-recipes/`) | ✅ No errors found |
| Favourites (`/recipes/favourites/`) | ✅ No errors found |
| Add Review (`/recipes/<id>/review/`) | ✅ No errors found |
...
#### Landing Page
![Landing Page Validation](docs/validation/landing-page.png)

#### Recipe Detail Page
![Recipe Detail Validation](docs/validation/recipe-detail.png)

#### Add Recipe Page
![Add Recipe Validation](docs/validation/add-recipe.png)

*(Additional screenshots available in `docs/validation/` folder)*
